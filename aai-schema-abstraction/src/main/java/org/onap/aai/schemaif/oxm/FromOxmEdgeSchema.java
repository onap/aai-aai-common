...
public class FromOxmEdgeSchema extends EdgeSchema {
    ...
    public void fromEdgeRule(EdgeRule edgeRule) throws SchemaProviderException {
        ...
        annotations.put(EdgeProperty.CONTAINS.toString(), edgeRule.getContains());
        annotations.put(EdgeProperty.DELETE_OTHER_V.toString(), edgeRule.getDeleteOtherV());
        annotations.put(EdgeProperty.PREVENT_DELETE.toString(), edgeRule.getPreventDelete());
