...
public class ErrorLogHelper {
    ...
    public static org.onap.aai.domain.restServiceException.RESTResponse getRESTAPIErrorResponse2(AAIException aaiException,
    ...
    private static String createExceptionResponseXml(ArrayList<String> variables, final AAIException aaiException,
            final String text) throws JAXBException {
