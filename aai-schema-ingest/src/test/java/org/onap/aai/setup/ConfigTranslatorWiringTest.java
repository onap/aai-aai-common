...
@ContextConfiguration(
    classes = {SchemaLocationsBean.class, SchemaVersions.class,
        ConfigTranslatorForWiringTest.class})
@TestPropertySource(
    properties = {
...
public class ConfigTranslatorWiringTest {
    ...
    public void test() {
        ...
        assertTrue("src/test/resources/oxm/test_business_v10.xml"
            .equals(nodes.get(new SchemaVersion("v10")).get(0)));
        ...
        assertTrue("src/test/resources/edgeRules/test.json"
            .equals(edges.get(new SchemaVersion("v10")).get(0)));
    }
