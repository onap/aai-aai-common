...
public class NodeIngestorLocalTest {
    ...
    public void testGetVersionFromClassName() {
        assertEquals(nodeIngestor.getVersionFromClassName("inventory.aai.onap.org.v13.Evc"),
    ...
    public void testCombinedSchema() throws TransformerException, IOException {
        ...
        String content = new String(
            Files.readAllBytes(Paths.get("src/test/resources/forWiringTests/aai_oxm_v13.xml")));
