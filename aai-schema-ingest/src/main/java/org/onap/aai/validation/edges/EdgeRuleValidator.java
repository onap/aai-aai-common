...
public class EdgeRuleValidator {
    ...
    public EdgeRuleValidator(ConfigTranslator config, SchemaErrorStrategy strat,
        ...
        SingleContainmentValidationModule containsValidator,
        CousinDefaultingValidationModule defaultsValidator,
    ...
    public boolean validate() {
        ...
        for (Map.Entry<SchemaVersion, List<DocumentContext>> verEntry : versionJsonFilesMap
            .entrySet()) {
