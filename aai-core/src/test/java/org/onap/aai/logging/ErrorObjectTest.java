...
public class ErrorObjectTest {
    ...
    ErrorObject newErrorObject = new ErrorObject("disposition", "category", "severity", 200,
        "restErrorCode", "errorCode", "errorText");
    ...
    public void createObjectTest1() {
        ...
        ErrorObject errorObject =
            new ErrorObject("severity", "errorcode", "errortext", "disposition", "category");
    ...
    public void createObjectTest2() {
        ...
        ErrorObject errorObject =
            new ErrorObject("severity", 200, "errorcode", "errortext", "disposition", "category");
        assertNotNull(errorObject);
    }
    ...
    public void createObjectTest3() {
        ...
        ErrorObject errorObject = new ErrorObject("severity", Status.OK, "errorcode", "errortext",
