...
public class ExcludeQueryTest extends AAISetup {
    ...
    private QueryBuilder<Vertex> buildTestQuery(QueryBuilder<Vertex> qb) throws AAIException {
        return qb.createEdgeTraversal(EdgeType.TREE, "cloud-region", "availability-zone")
            .getVerticesExcludeByProperty("hypervisor-type", "hypervisortype-11").store("x")
            .cap("x").unfold().dedup();
    }
    ...
    public void gremlinQueryExcludeTest() throws AAIException {
        ...
        Vertex availibityzone11 = graph.addVertex(T.label, "availability-zone", T.id, "11",
            "aai-node-type", "availability-zone", "availability-zone-name", "az-name-11",
            "hypervisor-type", "hypervisortype-11");
        ...
        Vertex availibityzone12 = graph.addVertex(T.label, "availability-zone", T.id, "12",
            "aai-node-type", "availability-zone", "availability-zone-name", "az-name-12",
            "hypervisor-type", "hypervisortype-12");
