...
public class PrivateEdgeTest extends AAISetup {
    ...
    public static void setup() throws Exception {
        ...
        graph.traversal()
            ...
            .as("v5")
            .addV("aai-node-type", "model-ver", "model-ver", "myValue", "model-version-id",
                "key200", "model-version", "testValue", AAIProperties.AAI_URI,
    ...
    public void testWhenPrivateEdgeThrowsExceptionWhenHavingOnlyOnePartOfKey() throws Exception {
        ...
        Vertex selfV = traversal.addV("aai-node-type", "generic-vnf", "vnf-id", "myId", "aai-uri",
            obj.getURI(), "model-invariant-id", "key1").next();
