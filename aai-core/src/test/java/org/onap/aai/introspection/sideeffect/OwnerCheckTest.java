...
public class OwnerCheckTest extends AAISetup {
    ...
    public static void setup() {
        ...
        graph.traversal()
            ...
            .property(AAIProperties.AAI_URI,"/service-design-and-creation/models/model/key1/business/owning-entities/owning-entity/367c897c-8cec-47ba-b7f5-4b6139f06691")
            .as("oe")
    ...
    public void shouldFailComparisonWithDiffOwningEntity() throws Exception  {
        ...
        Vertex selfV = traversal.addV("pnf")
