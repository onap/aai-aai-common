 ...
 * ================================================================================
 * Modfications Copyright © 2018 IBM.
 * ================================================================================
...
public class MapperUtilTest {
    ...
    @Test
    public void writeAsJSONStringWithDashesTest() throws Exception {
        expectedJson.put("color", "blue");
        expectedJson.put("shape", "cube");
        SampleClass sample = new SampleClass("blue", "cube");
        assertEquals(expectedJson.toString(), MapperUtil.writeAsJSONStringWithDashes(sample));
    }
