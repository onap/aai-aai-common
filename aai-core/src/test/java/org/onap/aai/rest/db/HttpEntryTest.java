...
public class HttpEntryTest extends AAISetup {
    ...
    public void getRelationshipListTest()
        ...
        String requestBody = "";
        Response response = doRequest(traversalHttpEntry, loader, dbEngine, HttpMethod.GET_RELATIONSHIP, uri, requestBody);
    ...
    public void getRelationshipListTestWithFormatSimple() throws UnsupportedEncodingException, AAIException {
        ...
        JSONObject relationshipData = new JSONObject().put("relationship-key", "complex.physical-location-id").put("relationship-value","related-to-complex");
        JSONObject relationship = new JSONObject()
            .put("related-to","complex")
            .put("relationship-label","org.onap.relationships.inventory.LocatedIn")
            .put("related-link", String.format("/aai/%s/cloud-infrastructure/complexes/complex/related-to-complex", schemaVersions.getDefaultVersion()))
