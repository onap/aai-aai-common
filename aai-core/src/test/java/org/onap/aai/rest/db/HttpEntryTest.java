...
public class HttpEntryTest extends AAISetup {
    ...
    @Test
    public void thatUpdateFailsWhenResourceVersionsMismatch() throws UnsupportedEncodingException, AAIException {
        String uri = "/cloud-infrastructure/pservers/pserver/theHostname";
        dbEngine.tx().traversal().addV()
                .property("aai-node-type", "pserver")
                .property("hostname", "theHostname")
    ...
    @Test
    public void thatUpdateFailsWhenResourceVersionIsNotProvided() throws UnsupportedEncodingException, AAIException {
        String uri = "/cloud-infrastructure/pservers/pserver/theHostname";
        dbEngine.tx().traversal().addV()
                .property("aai-node-type", "pserver")
                .property("hostname", "theHostname")
