...
@ContextConfiguration(
    classes = {SchemaLocationsBean.class, SchemaVersions.class,
        AAICorePrivateEdgeTestConfigTranslator.class, EdgeIngestor.class, EdgeSerializer.class,
        SpringContextAware.class})
@DirtiesContext
public class GraphSONTest {

    private static final EELFLogger LOGGER =
        EELFManager.getInstance().getLogger(GraphSONTest.class);
    ...
    public void testGraphWithVertexHavingPrivateEdges()
        ...
        Vertex genericVnf = graph.addVertex(T.label, "generic-vnf", T.id, "20", "aai-node-type",
            "generic-vnf", "vnf-id", "vnf-id-1", "vnf-name", "vnf-name-1");

        Vertex modelVer = graph.addVertex(T.label, "model-ver", T.id, "21", "aai-node-type",
            "model-ver", "model-version-id", "modelVer1", "model-name", "modelName1");
    ...
    public void testGraphWithSameLabelWithPrivateEdgeAndRegularEdge()
        ...
        Vertex modelElement =
            graph.addVertex(T.label, "model-element", T.id, "22", "aai-node-type", "model-element");
    ...
    public void testGraphWithMultipleLabelWithOneLabelWithPrivateEdgeAndRegularEdgeAndAnotherLabelWithRegularEdge()
        ...
        Vertex metadatum =
            graph.addVertex(T.label, "metadatum", T.id, "23", "aai-node-type", "metadatum");
    ...
    public void testWhenMultipleEdgeLabelsBothOnlyHavePrivateEdges()
        ...
        Vertex modelPrivate =
            graph.addVertex(T.label, "model-private", T.id, "22", "aai-node-type", "model-private");
