...
public class CountQuerySupportTest extends AAISetup {
    ...
    public void setUp() throws Exception {
        ...
        pserver1 = graph.addVertex(T.label, "pserver", T.id, "2", "aai-node-type", "pserver",
            "hostname", "hostname-1");
    ...
    public void verifyComplexVertexCountTest1()
        ...
        assertEquals(2,
            jo.get("results").getAsJsonArray().get(0).getAsJsonObject().get("complex").getAsInt());
    }
    ...
    public void verifyPserverVertexCountTest1()
        ...
        assertEquals(1,
            jo.get("results").getAsJsonArray().get(0).getAsJsonObject().get("pserver").getAsInt());
    }
    ...
    @Test
    public void verifyLongTest()
        throws AAIFormatVertexException, AAIException, AAIFormatQueryResultFormatNotSupported {
        List<Object> complexList = Arrays.asList(Long.valueOf(22L));
        JsonObject jo = this.formatter.output(complexList);
        assertEquals(22,
            jo.get("results").getAsJsonArray().get(0).getAsJsonObject().get("count").getAsInt());
    }
