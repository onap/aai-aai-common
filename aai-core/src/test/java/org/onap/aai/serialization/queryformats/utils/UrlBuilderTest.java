...
public class UrlBuilderTest extends AAISetup {
    ...
    public void v11Pathed() throws AAIFormatVertexException {
        ...
        UrlBuilder builder =
            new UrlBuilder(version, serializer, protocolAndHost, schemaVersions, basePath);
    ...
    public void v11Id() {
        ...
        assertEquals("has no protocol and host", basePath + "/" + version + "/resources/id/" + vId,
            result);
    ...
    public void beforeV11Id() {
        ...
        assertEquals("has protocol and host", protocolAndHost + version + "/resources/id/" + vId,
            result);
