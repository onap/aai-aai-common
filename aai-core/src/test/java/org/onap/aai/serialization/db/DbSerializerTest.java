...
public class DbSerializerTest extends AAISetup {
    ...
    public void testFindDeletableDoesNotReturnDuplicates() throws AAIException {
        ...
        Vertex genericVnf1 = graph.addVertex("aai-node-type", "generic-vnf", "vnf-id", "vnf1",
            "vnf-name", "vnfName1");

        Vertex lInterface1 =
            graph.addVertex("aai-node-type", "l-interface", "interface-name", "lInterface1");
        Vertex lInterface2 =
            graph.addVertex("aai-node-type", "l-interface", "interface-name", "lInterface2");

        Vertex logicalLink1 =
            graph.addVertex("aai-node-type", "logical-link", "link-name", "logicalLink1");
        Vertex logicalLink2 =
            graph.addVertex("aai-node-type", "logical-link", "link-name", "logicalLink2");
    ...
    public void subnetSetup() throws AAIException {
        ...
        Vertex l3interipv4addresslist_1 =
            graph.traversal().addV("aai-node-type", "l3-interface-ipv4-address-list",
                "l3-interface-ipv4-address", "l3-interface-ipv4-address-1").next();
        Vertex subnet_2 =
            graph.traversal().addV("aai-node-type", "subnet", "subnet-id", "subnet-id-2").next();
        Vertex l3interipv6addresslist_3 =
            graph.traversal().addV("aai-node-type", "l3-interface-ipv6-address-list",
                "l3-interface-ipv6-address", "l3-interface-ipv6-address-3").next();
        Vertex subnet_4 =
            graph.traversal().addV("aai-node-type", "subnet", "subnet-id", "subnet-id-4").next();
        Vertex subnet_5 =
            graph.traversal().addV("aai-node-type", "subnet", "subnet-id", "subnet-id-5").next();
        Vertex l3network_6 = graph.traversal().addV("aai-node-type", "l3-network", "network-id",
            "network-id-6", "network-name", "network-name-6").next();
    ...
    public void l3NetworkSetup() throws AAIException {
        ...
        Vertex l3network1 = graph.addVertex("aai-node-type", "l3-network", "network-id",
            "network-id-v1", "network-name", "network-name-v1");
        Vertex l3network2 = graph.addVertex("aai-node-type", "l3-network", "network-id",
            "network-id-v2", "network-name", "network-name-v2");
        ...
        Vertex l3interipv4addresslist_1 = graph.addVertex("aai-node-type",
            "l3-interface-ipv4-address-list", "l3-interface-ipv4-address", "l3-intr-v1");
        Vertex l3interipv6addresslist_1 = graph.addVertex("aai-node-type",
            "l3-interface-ipv6-address-list", "l3-interface-ipv6-address", "l3-interface-ipv6-v1");
    ...
    public void vserverSetup() throws AAIException {
        ...
        Vertex lInterface1 =
            graph.addVertex("aai-node-type", "l-interface", "interface-name", "lIntr1");
        Vertex lInterface2 =
            graph.addVertex("aai-node-type", "l-interface", "interface-name", "lIntr2");

        Vertex logicalLink1 =
            graph.addVertex("aai-node-type", "logical-link", "link-name", "logLink1");
        Vertex logicalLink2 =
            graph.addVertex("aai-node-type", "logical-link", "link-name", "logLink2");

        Vertex l3interipv4addresslist_1 =
            graph.addVertex("aai-node-type", "l3-interface-ipv4-address-list",
                "l3-interface-ipv4-address", "l3-intr-ipv4-address-1");
        Vertex l3interipv6addresslist_2 =
            graph.addVertex("aai-node-type", "l3-interface-ipv6-address-list",
    ...
    public void subnetDelWithInEdgesIpv4Test() throws AAIException {
         ...
         */
        Vertex subnet = graph.traversal().V().has("aai-node-type", "subnet")
            .has("subnet-id", "subnet-id-2").next();
    ...
    public void subnetDelWithInEdgesIpv6Test() throws AAIException {
         ...
         */
        Vertex subnet = graph.traversal().V().has("aai-node-type", "subnet")
            .has("subnet-id", "subnet-id-4").next();
        String exceptionMessage = testCascadeDelete(subnet);
        assertEquals(expected_message, exceptionMessage);
    ...
    public void subnetDelWithInEdgesL3network() throws AAIException {
         ...
         */
        Vertex subnet = graph.traversal().V().has("aai-node-type", "subnet")
            .has("subnet-id", "subnet-id-5").next();
    ...
    public String testCascadeDelete(Vertex v) throws AAIException {
        ...
        DBSerializer serializer =
            new DBSerializer(version, spy, introspectorFactoryType, "AAI_TEST");
    ...
    public void createNewVertexTest() throws AAIException {
        ...
        Vertex fromGraph =
            engine.tx().traversal().V().has("aai-node-type", "generic-vnf").toList().get(0);
        assertEquals(testVertex.id(), fromGraph.id());
        assertEquals("AAI-TEST",
            fromGraph.property(AAIProperties.SOURCE_OF_TRUTH.toString()).value());
    ...
    public void touchStandardVertexPropertiesTest() throws AAIException, InterruptedException {
        ...
        // if this test runs through too fast the value may not change, causing the test to fail.
        // sleeping ensures a different value
        Thread.sleep(2);
        DBSerializer dbser2 =
            new DBSerializer(version, engine, introspectorFactoryType, "AAI-TEST-2");
        ...
        // Not new vertex && new DBSerializer (A new serializer since a new one will be created per
        // transaction)
        // Here the vertex will be modified by a different source of truth
        DBSerializer dbser3 =
            new DBSerializer(version, engine, introspectorFactoryType, "AAI-TEST-3");
        ...
        // The currentTimeMillis used for the created-ts and modified-ts is created at DBSerializer
        // instantiation
        // Every REST transaction should create a new DBSerializer - thus a new currentTimeMillis is
    ...
    public void touchStandardVertexPropertiesAAIUUIDTest()
        throws AAIException, InterruptedException {
        engine.startTransaction();
    ...
    public void verifyResourceVersion_SunnyDayTest() throws AAIException {
        ...
        assertTrue(
            dbser.verifyResourceVersion("delete", "vnfc", "abc", "abc", "vnfcs/vnfc/vnfcId"));
    ...
    public void verifyResourceVersion_CreateWithRVTest() throws AAIException {
        ...
        dbser.verifyResourceVersion("create", "generic-vnf", null, "old-res-ver",
    ...
    public void verifyResourceVersion_MissingRVTest() throws AAIException {
        ...
        thrown.expectMessage(
            "resource-version not passed for update of generic-vnfs/generic-vnf/myid");
        dbser.verifyResourceVersion("update", "generic-vnf", "current-res-ver", null,
            "generic-vnfs/generic-vnf/myid");
    ...
    public void verifyResourceVersion_MismatchRVTest() throws AAIException {
        ...
        thrown.expect(AAIException.class);
        thrown
            .expectMessage("resource-version MISMATCH for update of generic-vnfs/generic-vnf/myid");
    ...
    @Test
    public void getURIForVertexTest()
        throws AAIException, URISyntaxException, UnsupportedEncodingException {
        engine.startTransaction();

        Vertex cr = engine.tx().addVertex("aai-node-type", "cloud-region", "cloud-owner", "me",
            "cloud-region-id", "123", "aai-uri",
            "/cloud-infrastructure/cloud-regions/cloud-region/me/123");
        Vertex ten = engine.tx().addVertex("aai-node-type", "tenant", "tenant-id", "453");

        edgeSer.addTreeEdge(engine.tx().traversal(), cr, ten);

        ten.property("aai-uri",
            "/cloud-infrastructure/cloud-regions/cloud-region/me/123/tenants/tenant/453");

        URI compare =
            new URI("/cloud-infrastructure/cloud-regions/cloud-region/me/123/tenants/tenant/453");
    ...
    public void deleteEdgeTest() throws AAIException, UnsupportedEncodingException {
        ...
        Vertex gvnf = engine.tx().addVertex("aai-node-type", "generic-vnf", "vnf-id", "myvnf",
            "aai-uri", "/network/generic-vnfs/generic-vnf/myvnf");
        Vertex vnfc = engine.tx().addVertex("aai-node-type", "vnfc", "vnfc-name", "a-name",
            "aai-uri", "/network/vnfcs/vnfc/a-name");
    ...
    public void createEdgeTest() throws AAIException, UnsupportedEncodingException {
        ...
        assertTrue(engine.tx().traversal().V(gvnf)
            .both("org.onap.relationships.inventory.BelongsTo").hasNext());
        assertTrue(engine.tx().traversal().V(vnfc)
            .both("org.onap.relationships.inventory.BelongsTo").hasNext());
    ...
    public void createCousinEdgeThatShouldBeTreeTest()
        ...
        Vertex vf = engine.tx().addVertex("aai-node-type", "vf-module", "vf-module-id", "vf-id",
            "aai-uri", "/network/generic-vnfs/generic-vnf/myvnf/vf-modules/vf-module/vf-id");
        ...
        relationshipList.setValue("relationship",
            Collections.singletonList(relationship.getUnderlyingObject()));
        ...
        QueryParser uriQuery = dbEngine.getQueryBuilder()
            .createQueryFromURI(new URI("/network/generic-vnfs/generic-vnf/myvnf-1"));
    ...
    @Test
    public void createEdgeNodeDoesNotExistExceptionTest()
        ...
        thrown.expect(AAIException.class);
        thrown.expectMessage(
            "Node of type vnfc. Could not find object at: /network/vnfcs/vnfc/b-name");
        dbser.createEdge(relationship, gvnf);

    }

    @Test
    public void serializeSingleVertexTopLevelTest()
        throws AAIException, UnsupportedEncodingException {
        engine.startTransaction();
    ...
    public void serializeSingleVertexChildTest() throws AAIException, UnsupportedEncodingException {
        ...
        assertTrue(engine.tx().traversal().V().has("aai-node-type", "tenant")
            .has("tenant-id", "453").has("tenant-name", "mytenant").hasNext());

    }

    @Test
    public void getVertexPropertiesRelationshipHasLabelTest()
        throws AAIException, UnsupportedEncodingException {
        engine.startTransaction();

        Vertex gvnf = engine.tx().addVertex("aai-node-type", "generic-vnf", "vnf-id", "vnf-123",
            "aai-uri", "/network/generic-vnfs/generic-vnf/vnf-123");
        Vertex vnfc = engine.tx().addVertex("aai-node-type", "vnfc", "vnfc-name", "vnfc-123",
            "aai-uri", "/network/vnfcs/vnfc/vnfc-123");

        edgeSer.addEdge(engine.tx().traversal(), gvnf, vnfc);

        Introspector obj = loader.introspectorFromName("generic-vnf");
        obj = this.dbser.dbToObject(Arrays.asList(gvnf), obj, AAIProperties.MAXIMUM_DEPTH, false,
            "false");

        MarshallerProperties properties = new MarshallerProperties.Builder(
            org.onap.aai.restcore.MediaType.getEnum("application/json")).formatted(true).build();
        System.out.println(obj.marshal(properties));

        assertEquals("edge label between generic-vnf and vnfs is uses",
            "org.onap.relationships.inventory.BelongsTo", obj.getWrappedValue("relationship-list")
                .getWrappedListValue("relationship").get(0).getValue("relationship-label"));
    ...
    public void getVertexPropertiesRelationshipOldVersionNoEdgeLabelTest()
        ...
        Introspector obj = loader.introspectorFromName("generic-vnf");
        obj =
            dbser.dbToObject(Arrays.asList(gvnf), obj, AAIProperties.MAXIMUM_DEPTH, false, "false");

        assertEquals("Relationship does not contain edge-property", false,
            obj.getWrappedValue("relationship-list").getWrappedListValue("relationship").get(0)
                .hasProperty("relationship-label"));
    ...
    public void createEdgeWithInvalidLabelTest() throws AAIException, UnsupportedEncodingException,
        ...
        Vertex gvnf = engine.tx().addVertex("aai-node-type", "generic-vnf", "vnf-id", "myvnf",
            "aai-uri", "/network/generic-vnfs/generic-vnf/myvnf");
        engine.tx().addVertex("aai-node-type", "vnfc", "vnfc-name", "a-name", "aai-uri",
    ...
    public void addRelatedToPropertyTest() throws AAIException {
        ...
        Vertex gvnf = engine.tx().addVertex("aai-node-type", "generic-vnf", "vnf-id", "myname",
            "vnf-name", "myname", "aai-uri", "/network/generic-vnfs/generic-vnf/myname");
        engine.tx().addVertex("aai-node-type", "vnfc", "vnfc-name", "a-name", "aai-uri",
            "/network/vnfcs/vnfc/a-name");
    ...
    @Test
    public void dbToObjectContainerMismatchTest()
        throws AAIException, UnsupportedEncodingException {
        DBSerializer dbser = new DBSerializer(schemaVersions.getAppRootVersion(), dbEngine,
            ModelType.MOXY, "AAI-TEST");
        ...
        Loader loader = loaderFactory.createLoaderForVersion(ModelType.MOXY,
            schemaVersions.getAppRootVersion());
        Introspector intro = loader.introspectorFromName("image"); // just need any non-container
                                                                   // object
    ...
    public void getEdgeBetweenNoLabelTest() throws AAIException {
        ...
        Vertex lint =
            engine.tx().addVertex("aai-node-type", "l-interface", "interface-name", "name1");
    ...
    @Test
    public void serializeToDbWithParentTest()
        throws AAIException, UnsupportedEncodingException, URISyntaxException {
        DBSerializer dbser = new DBSerializer(version, engine, ModelType.MOXY, "AAI-TEST");
        engine.startTransaction();
        Vertex gv = engine.tx().addVertex("aai-node-type", "generic-vnf", "vnf-id", "id1",
            "aai-uri", "/network/generic-vnfs/generic-vnf/id1");
        ...
        URI lintURI =
            new URI("/network/generic-vnfs/generic-vnf/id1/l-interfaces/l-interface/name1");
    ...
    public void cascadeVserverDeleteTest() throws AAIException {
         ...
         */
        Vertex vserver =
            graph.traversal().V().has("aai-node-type", "vserver").has("vserver-id", "vss1").next();
    ...
    public void cascadeL3NetworkPreventDeleteTest() throws AAIException {
         ...
         * -->l3-ipvx-list
         */
        Vertex l3network = graph.traversal().V().has("aai-node-type", "l3-network")
            .has("network-id", "network-id-v1").next();
    ...
    public void cascadeL3NetworkDeleteTest() throws AAIException {
         ...
         */
        Vertex l3network = graph.traversal().V().has("aai-node-type", "l3-network")
            .has("network-id", "network-id-v2").next();
