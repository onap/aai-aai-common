...
public class URIToRelationshipObjectTest extends AAISetup {
     ...
     */
    @Test
    public void uri() throws JAXBException, AAIException, IllegalArgumentException,
     ...
     */
    @Test
    public void doubleKeyRelationship() throws JAXBException, AAIException,
        IllegalArgumentException, UnsupportedEncodingException, URISyntaxException {
        URI uri = UriBuilder
            .fromPath("/aai/" + latest
