            ...
            for (int i = 0; i < parts.length;) {
                ...
                if (part.equals(RestTokens.COUSIN.toString())) {
                    ...
                    if (previousObj.isContainer() && introspector.isContainer()) {
                        throw new AAIException("AAI_3000",
                            uri + " not a valid path. Cannot chain plurals together");
                    }
                    ...
                    if (introspector.isContainer()) {
                         ...
                         * EdgeRuleBuilder use all the edgeTypes
                         */
                ...
                if (introspector != null) {
                    ...
                    if (previousObj != null && !previousObj.hasChild(introspector)
                        ...
                        throw new AAIException("AAI_3001",
                            uri + " not a valid path. " + part + " not valid");
                        ...
                        if (!isRelative && !abstractType.equals("true")
                            && !validNamespaces.hasChild(introspector)) {
                            throw new DoesNotStartWithValidNamespaceException(uri
