...
public class CreateWidgetModels {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Loader loader =
            loaderFactory.createLoaderForVersion(ModelType.MOXY, new SchemaVersion(_apiVersion));
        ...
        for (Entry<String, Introspector> aaiResEnt : loader.getAllObjects().entrySet()) {
            ...
            if (!(aaiRes.isContainer() || aaiRes.getName().equals("aai-internal"))) {
                ...
                if (!(introspectorProperties.contains("model-version-id")
                    ...
                    System.out.println(
                        aaiRes.getDbName() + " does not contain model properties so skipping");
                }
                ...
                String filePathString2 = widgetJsonDir + "/../widget-model-json-old/" + widgetName
                    + "-" + modelVersion + ".json";
                ...
                if (!f.exists() && !f.isDirectory()) {
                    ...
                    if (f2.exists()) {
                        ...
                        meObject =
                            loader.unmarshal("model", new StreamSource(f2).getReader().toString());
                        ...
                        // the modelVers is a list of dynamic entities so we can just attach the
                        // array here
