...
public abstract class QueryEngine {
    ...
    /**
     * Finds the subgraph under start, including cousins as well as start's
     ...
     */
    public abstract List<Vertex> findRelatedVertices(Vertex start, Direction direction,
        String label, String nodeType);

    /**
     * Finds cousin edges connecting start to other vertices only of types defined in an old
     * version.
     * The idea is that if a user is using an old version, they won't understand any new node types
     * in
     ...
     * @return list of cousin edges between start and any node types understood by the version
     *         specified in loader
     */
