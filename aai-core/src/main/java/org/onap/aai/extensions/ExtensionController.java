...
public class ExtensionController {
    ...
    private static final EELFLogger LOGGER =
        EELFManager.getInstance().getLogger(ExtensionController.class);
     ...
     */
    public void runExtension(String apiVersion, String namespace, String resourceName,
        String methodName, AAIExtensionMap aaiExtMap, boolean isPreExtension) throws AAIException {
        String extensionClassName = "org.onap.aai.extensions." + apiVersion.toLowerCase() + "."
            + namespace + "." + resourceName + "Extension";
        String defaultErrorCallback = resourceName + "ExtensionErrorCallback";

        String configOption = "aai.extensions." + apiVersion.toLowerCase() + "."
            + namespace.toLowerCase() + "." + resourceName.toLowerCase() + ".enabled";
        ...
        try {
                    ...
                    if (e != null) {
                        ...
                        if (handleException == true) {
                            ...
                            if (errorCallback != null) {
                                ...
                                Method defaultErrorCallbackExtension = clazz.getMethod(
                                    defaultErrorCallback, new Class[] {AAIExtensionMap.class});
                                defaultErrorCallbackExtension.invoke(clazz.newInstance(),
                                    aaiExtMap);
                            }
                        }
                    }
            ...
            LOGGER.debug("Extension class not found: " + extensionClassName + ", method: "
                + methodName + ".");
        } catch (NoSuchMethodException e) {
            LOGGER
                .debug("Method " + methodName + " does not exist for class " + extensionClassName);
