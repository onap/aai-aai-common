...
public class MoxyStrategy extends Introspector {
	...
	@Override
	public Set<String> getDbAliasProperties(){
	    return this.getProperties()
            .stream()
            .filter((prop) -> this.getPropertyMetadata(prop).containsKey(PropertyMetadata.DB_ALIAS))
            .map((prop) -> this.getPropertyMetadata(prop).get(PropertyMetadata.DB_ALIAS))
