...
public abstract class Introspector implements Cloneable {
    ...
    private static final EELFLogger LOGGER =
        EELFManager.getInstance().getLogger(Introspector.class);
    ...
    public Object castValueAccordingToSchema(String name, Object obj) {
        ...
        if (nameClass == null) {
            throw new IllegalArgumentException(
                "property: " + name + " does not exist on " + this.getDbName());
        }
        if (obj != null) {
    ...
    public Set<String> getSimpleProperties(PropertyPredicate<Introspector, String> p) {
        return this.getProperties().stream().filter(item -> p.test(this, item))
            .filter(this::isSimpleType).collect(Collectors.toSet());
    }
    ...
    public Introspector newIntrospectorInstanceOfProperty(String name)
        ...
        Introspector result =
            IntrospectorFactory.newInstance(this.getModelType(), this.newInstanceOfProperty(name));
    ...
    public Introspector newIntrospectorInstanceOfNestedProperty(String name)
        ...
        Introspector result = IntrospectorFactory.newInstance(this.getModelType(),
            this.newInstanceOfNestedProperty(name));
        ...
        if ("true".equals(this.getMetadata(ObjectMetadata.ABSTRACT))) {
            ...
            for (String inheritor : inheritors) {
                try {
                    ...
                    LOGGER.warn("Skipping inheritor " + inheritor + " (Unknown Object) "
    ...
    public String marshal(boolean formatted) {
        MarshallerProperties properties =
            new MarshallerProperties.Builder(MediaType.APPLICATION_JSON_TYPE).formatted(formatted)
                .build();
    ...
    public Optional<String> getPropertyMetadata(String propName, PropertyMetadata metadataName) {
        final String resultValue =
            this.getPropertyMetadata(propName).getOrDefault(metadataName, "");
