...
public abstract class Introspector implements Cloneable {
    ...
    /**
     * Returns a set of the properties within a object
     * that has the metadata dbalias associated with it
     *
     * @return  - a set of props with metadata dbalias
     */
	public abstract Set<String> getDbAliasProperties();
}
