...
public class HttpEntry {
    ...
    private Pair<Boolean, List<Pair<URI, Response>>> process(List<DBRequest> requests, String sourceOfTruth,
        ...
        for (DBRequest request : requests) {
            ...
            try {
                response = processRequest(request, serializer, groups, outputMediaType, enableResourceVersion, sourceOfTruth);
    ...
    private Response processRequest(DBRequest request, DBSerializer serializer, Set<String> groups, String outputMediaType, boolean enableResourceVersion, String sourceOfTruth) throws AAIException, UnsupportedEncodingException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, SecurityException, InstantiationException, NoSuchMethodException, URISyntaxException {
        try {
            QueryEngine queryEngine = dbEngine.getQueryEngine();
            Set<Vertex> mainVertexesToNotifyOn = new LinkedHashSet<>();
