...
public class TraversalQuery<E> extends GraphTraversalBuilder<E> {
    ...
    protected TraversalQuery(GraphTraversal<Vertex, E> traversal, Loader loader,
        GraphTraversalSource source, GraphTraversalBuilder<E> gtb) {
        super(loader, source);
     ...
     */
    @Override
    public QueryParser createQueryFromURI(URI uri)
