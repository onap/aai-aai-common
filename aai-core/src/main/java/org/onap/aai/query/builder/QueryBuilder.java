...
public abstract class QueryBuilder<E> implements Iterator<E> {
     ...
     */
    public abstract QueryBuilder<Vertex> getChildVerticesFromParent(String parentKey,
        String parentValue, String childType);
     ...
     */
    public abstract QueryBuilder<Vertex> getTypedVerticesByMap(String type,
     ...
     * @return the query builder
     */
    public abstract QueryBuilder<Vertex> createEdgeTraversal(EdgeType type, Introspector parent,
     ...
     * @return the query builder
     */
    public abstract QueryBuilder<Vertex> createPrivateEdgeTraversal(EdgeType type,
        Introspector parent, Introspector child) throws AAIException;
     ...
     * @return the query builder
     */
    public QueryBuilder<Vertex> createEdgeTraversal(EdgeType type, Vertex parent,
        Introspector child) throws AAIException {
     ...
     * @throws AAIException
     */
    public QueryBuilder<Vertex> createEdgeTraversal(EdgeType type, String outNodeType,
     ...
     * @throws AAIException
     */
    public QueryBuilder<Vertex> createEdgeTraversal(String edgeType, String outNodeType,
        String inNodeType) throws AAIException {
        /*
         * When the optional parameter edgetype is sent it is a string that needs to be converted to
         * Enum
         */
     ...
     * @throws AAIException
     */
    public QueryBuilder<Vertex> createEdgeTraversal(MissingOptionalParameter edgeType,
    ...
    public QueryBuilder<Vertex> createEdgeTraversal(String outNodeType, String inNodeType)
        throws AAIException {
    ...
    public QueryBuilder<Vertex> createPrivateEdgeTraversal(EdgeType type, String outNodeType,
        String inNodeType) throws AAIException {
        Introspector out = loader.introspectorFromName(outNodeType);
        Introspector in = loader.introspectorFromName(inNodeType);
     ...
     * @throws AAIException
     */
    public QueryBuilder<Vertex> createEdgeTraversalWithLabels(EdgeType type, String outNodeType,
     ...
     * @return
     */
    public abstract QueryBuilder<Vertex> createEdgeTraversalWithLabels(EdgeType type,
        Introspector out, Introspector in, List<String> labels) throws AAIException;
     ...
     * @throws AAIException
     */
    public abstract QueryBuilder<Edge> getEdgesBetweenWithLabels(EdgeType type, String outNodeType,
        String inNodeType, List<String> labels) throws AAIException;
     ...
     */
    public abstract QueryParser createQueryFromURI(URI uri)
    ...
    public QueryBuilder<Vertex> getVerticesByNumberProperty(String key,
        MissingOptionalParameter value) {
        return getVerticesByProperty(key, value);
    }
}
