...
public class RestController implements RestControllerInterface {
    ...
    public static final String REST_APIPATH_CLOUDREGION =
    ...
    public static final String REST_APIPATH_VIRTUAL_DATA_CENTERS =
    ...
    public static final String REST_APIPATH_INSTANCE_GROUP =
        "network/instance-groups/instance-group";
    ...
    public static final String REST_APIPATH_SERVICE =
    ...
    public void initRestClient() throws AAIException {
        if (client == null) {
            try {
                ...
                throw new AAIException("AAI_7117",
                    "KeyManagementException in REST call to DB: " + e.toString());
            } catch (Exception e) {
                throw new AAIException("AAI_7117",
                    " Exception in REST call to DB: " + e.toString());
            }
        }
    }
    ...
    public <T> void Get(T t, String sourceID, String transId, String path, RestObject<T> restObject,
        ...
        ClientResponse cres = client.resource(url).accept("application/json")
            .header("X-TransactionId", transId).header("X-FromAppId", sourceID)
            .header("Real-Time", "true").type("application/json").get(ClientResponse.class);
        ...
        if (cres.getStatus() == 200) {
            ...
            // cres.getStatus());
            throw new AAIException("AAI_7116",
                methodName + " with status=" + cres.getStatus() + ", url=" + url);
        }
    ...
    public <T> void Put(T t, String sourceID, String transId, String path, boolean oldserver,
        ...
        ClientResponse cres =
            client.resource(url).accept("application/json").header("X-TransactionId", transId)
                .header("X-FromAppId", sourceID).header("Real-Time", "true")
                .type("application/json").entity(t).put(ClientResponse.class);
        ...
        if (statuscode >= 200 && statuscode <= 299) {
            ...
            LoggingContext.restore();
            throw new AAIException("AAI_7116", methodName + " with status=" + statuscode + ", url="
                + url + ", msg=" + cres.getEntity(String.class));
        }
    }
    ...
    public void Delete(String sourceID, String transId, String path, int port) throws AAIException {
        ...
        ClientResponse cres =
            client.resource(url).accept("application/json").header("X-TransactionId", transId)
                .header("X-FromAppId", sourceID).header("Real-Time", "true")
                .type("application/json").entity(request).delete(ClientResponse.class);
    ...
    public <T> String Post(T t, String sourceID, String transId, String path) throws Exception {
        return Post(t, sourceID, transId, path,
     ...
     * @throws Exception the exception
     */
    public <T> String Post(T t, String sourceID, String transId, String path, String apiVersion)
        throws Exception {
        ...
        try {
            ...
            ClientResponse cres =
                client.resource(url).accept("application/json").header("X-TransactionId", transId)
                    .header("X-FromAppId", sourceID).header("Real-Time", "true")
                    .type("application/json").entity(t).post(ClientResponse.class);
            ...
            if (statuscode >= 200 && statuscode <= 299) {
                ...
                throw new AAIException("AAI_7116", methodName + " with status=" + statuscode
                    + ", url=" + url + ", msg=" + cres.getEntity(String.class));
            }

        } catch (AAIException e) {
            throw new AAIException("AAI_7116",
                methodName + " with url=" + url + ", Exception: " + e.toString());
        } catch (Exception e) {
            throw new AAIException("AAI_7116",
                methodName + " with url=" + url + ", Exception: " + e.toString());
     ...
     * 
     * Resourcepath: should contain the qualified resource path (including encoded unique key
     * identifier value),
     ...
     * <encoded-link-name>, resourceClassName, fromAppId, transId);
     */
    public <T> T DoesResourceExist(String resourcePath, String resourceClassName, String fromAppId,
        ...
        try {
            ...
            Get(resourceObj, fromAppId, transId, resourcePath, restObj, false,
                AAIConstants.AAI_RESOURCES_PORT);
    ...
    public <T> void Patch(T t, String sourceID, String transId, String path) throws AAIException {
        ...
        try {
            ...
            do {
                ...
                cres = client.resource(url).accept("application/json")
                    .header("X-TransactionId", transId).header("X-FromAppId", sourceID)
                    .header("X-HTTP-Method-Override", "PATCH").type("application/merge-patch+json")
                    .entity(t).post(ClientResponse.class);
                ...
                if (statusCode >= 200 && statusCode <= 299) {
                    ...
                    LOGGER.debug(methodName + "Unable to make the patch request to url " + url
                        + " so retrying");
                }
            ...
            LOGGER.debug(methodName + "Unable to make the patch request to url " + url
                + " even after trying = " + numRetries + " times.");
            throw new AAIException("AAI_7116", methodName + " with status=" + statusCode + ", url="
                + url + ", msg=" + cres.getEntity(String.class));
