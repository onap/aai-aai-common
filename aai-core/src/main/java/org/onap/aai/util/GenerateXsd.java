...
public class GenerateXsd {
    ...
    private static int swaggerSupportStartsVersion = 1; // minimum version to support swagger
                                                        // documentation
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (versionToGen == null) {
            ...
            System.exit(1);
        } else if (!"ALL".equalsIgnoreCase(versionToGen) && !versionToGen.matches("v\\d+")
        ...
        if (System.getProperty("user.dir") != null
            && !System.getProperty("user.dir").contains(normalStartDir)) {
