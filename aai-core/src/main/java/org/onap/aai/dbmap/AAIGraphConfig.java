...
/**
 * For building a config that JanusGraphFactory.open can use with an identifiable
 * graph.unique-instance-id
 */
public class AAIGraphConfig {

    private static final EELFLogger logger =
        EELFManager.getInstance().getLogger(AAIGraphConfig.class);
    ...
    public PropertiesConfiguration getCc(String configPath, String graphType, String service)
        ...
        String uid = ManagementFactory.getRuntimeMXBean().getName() + "_" + service + "_"
            + graphType + "_" + System.currentTimeMillis();
    ...
    public static class Builder {
        ...
        public PropertiesConfiguration buildConfiguration()
            throws ConfigurationException, FileNotFoundException {
