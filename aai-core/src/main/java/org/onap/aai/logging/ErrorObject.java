...
public class ErrorObject {
     ...
     */
    public ErrorObject(String disposition, String category, String severity,
        Integer httpResponseCode, String restErrorCode, String errorCode, String errorText) {
        super();
     ...
     * @param category the category
     */
    public ErrorObject(String severity, String errorCode, String errorText, String disposition,
        String category) {
     ...
     * @param category the category
     */
    public ErrorObject(String severity, Integer httpResponseCode, String errorCode,
        String errorText, String disposition, String category) {
        super();
        this.severity = severity;
        this.setHTTPResponseCode(httpResponseCode);
        this.setErrorCode(errorCode);
     ...
     * @param category the category
     */
    public ErrorObject(String severity, Status httpResponseCode, String errorCode, String errorText,
